...
class LwScore:
    ...
    def __init__(self, score_id: Optional[int]=None, pp: Optional[int]=None, score_: Optional[scoreAuto.score]=None):
        """
...
class Worker:
    ...
    def recalc_score(self, score_data: Dict) -> scoreAuto:
        """
        ...
        s: scoreAuto.score = scoreAuto.score()
